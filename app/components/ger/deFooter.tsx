    ...
    <footer className="bg-bluebg text-white py-10 px-5">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="mt-2 max-w-md">WENN LÄCHELN AUF EXPERTISE TRIFFT</p>
          <p className="mt-4 text-gray-400">
            © {new Date().getFullYear()} Perfect Smile Experts. Alle Rechte
            vorbehalten - Schnellzugriffe.
          </p>
        </div>

        {/* Enlaces Rápidos */}
        <div className="flex flex-col items-center md:items-start">
          <h4 className="text-lg font-semibold">Folgen Sie uns</h4>
